...
const StudentLayout = () => {
  ...
  const [showDocumentAssistant, setShowDocumentAssistant] = useState(false);
  ...
  const handleDocumentClick = () => {
    setShowDocumentAssistant(!showDocumentAssistant);
    setShowTab(false);
  };
  ...
  return (
    <div className="min-h-screen bg-[#E9EEF4] flex pt-[72px] relative">
        ...
        {showTab && (
          ...
          >
            <div
              ...
              className="flex gap-[12px] rounded-[8px] justify-center items-center bg-[#04203E] px-[12px] py-[8px] cursor-pointer"
            >
              <img src={pdf} />
      ...
      {showDocumentAssistant && (
        <div>
          <div
            className="absolute inset-0 bg-[#1F1D1D]/[0.24] z-10"
            onClick={() => setShowDocumentAssistant(false)} // 👈 Optional
          ></div>

          <div className="fixed right-0 top-0 z-500 bg-[#FAFCFD] w-[30%]">
            <DocumentAssistant
              setShowDocumentAssistant={setShowDocumentAssistant}
              showDocumentAssistant={showDocumentAssistant}
            />
          </div>
        </div>
      )}

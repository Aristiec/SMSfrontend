...
const CreateUserForm = ({ isOpen, onClose, onSubmit, onNavigateToRoles }) => {
  ...
  const handleManageRoles = () => {
    // Navigate to the roles tab and close current form
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="flex items-center gap-1 text-[#0077FF] font-[Inter] font-medium text-[14px] hover:underline transition-colors"
              >

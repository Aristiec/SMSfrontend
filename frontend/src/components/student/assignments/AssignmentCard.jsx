        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-between flex-wrap">
            ...
            <div className="flex items-start gap-2 mt-2 sm:mt-0">
              {assignment.status === "overdue" ? (<img src={anti} />) : assignment.status === "pending" ? (<img src={pending} />) : (<img src={submitted} />)}
              <p className={`${assignment.status === "overdue" ? "text-[#EF4444]" :assignment.status === "pending" ? "text-[#F97316]" : "text-[#10B981]"} text-[16px] font-[600] leading-[17px] `}>

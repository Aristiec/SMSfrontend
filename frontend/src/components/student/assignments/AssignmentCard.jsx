...
import { fetchAssignmentById } from "../../../features/auth/authAPI";
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex justify-between flex-wrap">
          ...
          <div className="flex items-start gap-2 mt-2 sm:mt-0">
            <img src={statusIcon} />
            <p
              className={`text-[16px] font-[600] leading-[17px] ${statusColor}`}
            >
        ...
        >
          <div className="flex flex-col gap-1">
            ...
            <ul className="list-disc list-inside">
              ...
              <li>Literary device (e.g., symbolism, motifs, foreshadowing)</li>
            </ul>
            <p>Review at least 3 academic sources (books, journals, essays).</p>
          ...
          <div className="flex flex-col py-[12px] gap-[12px]">
            ...
            <div className="flex flex-col gap-[8px]">
              <div className="flex gap-[8px] rounded-[8px] p-[8px] bg-[#CFDCEB]">
                <img src={page} />
                <p className="text-[#04203E] text-[13.6px]">

...
<<<<<<<< HEAD:frontend/src/components/student/Exam/Online/preExam/Instructions.jsx
const Instructions = () => {
...
>>>>>>>> f591ff8 (onlineexam):frontend/src/components/student/Exam/Online/preExam/PreExamSet.jsx
...
========
        <div onClick={()=> navigate("/student/preexam2")} className="flex items-center bg-[#04203E] rounded-[8px] px-4 py-3 cursor-pointer">

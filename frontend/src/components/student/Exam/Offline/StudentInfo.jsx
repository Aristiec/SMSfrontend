...
const StudentInfo = ({ student }) => (
  <div className="bg-[#FAFCFD] rounded-lg p-6 shadow-sm ">
    ...
    <div className="mt-5">
      <button className="w-full flex items-center justify-center gap-2 bg-[#04203E] text-[#FAFCFD] font-[Inter] px-5 py-3 rounded-lg text-[14px] font-[Inter] hover:bg-[#031a32] transition-colors">
        <svg

          ...
          >
            <div className="flex justify-between ">
              <div className="flex gap-3 items-center">
                <div className={`flex items-center justify-center w-8 h-8 rounded-full ${stop.isCurrentStop ? "bg-[blue]" : "bg-[#FAFCFD]"}`}><MapPin size={16} color={stop.isCurrentStop ? "#FAFCFD" : "#1F1D1D"} /></div>

...
function AcedmicCalender() {
  return (
    <section className="mx-auto  w-full top-[100px] bg-[#E9EEF4] flex flex-col gap-8 mt-138px font-[Inter] px-4">
      {/* Main Content Container */}
      <div
        className=" h-[52px] rounded-[12px]  gap-[16px] bg-[#04203E]  "
        style={{
          opacity: 1,
      ...
      >
        <div className=" h-[72px] ml-8 mt-3  opacity-100 ">

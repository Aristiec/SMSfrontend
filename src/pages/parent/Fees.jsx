...
const Help = () => {
  ...
  const statusOptions = ["Select Department", "Active", "Inactive"];
  ...
  return (
    <div className="max-w-5x1 mt-0 mx-auto px-4 overflow-x-hidden">
      ...
      <div className="rounded-md shadow overflow-hidden border-gray-200">
        ...
        <div className="bg-white p-8 w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex flex-row gap-20 items-center">
              ...
              <div className="w-full">
                ...
                <Dropdown
                  ...
                  className=" font-[400] text-[16px] border-[#E5E5E5] px-[16px] py-[12px]"
                />
              </div>
            ...
            <div className="flex justify-end mt-6">
              <button
                type="submit"
                className="flex items-center gap-2 bg-[#04203E] text-white px-2 py-1 rounded hover:bg-blue-800 transition"
              >

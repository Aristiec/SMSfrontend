  ...
  return (
    <div className="mx-auto bg-[#E9EEF4] flex flex-col gap-8 min-h-screen font-[Inter]">
      <div className="flex flex-col px-4 gap-5 mt-4">
        ...
        {/* Header */}
        <div className=" top-20 rounded-[12px] px-6 py-4 bg-[#04203E] flex items-center justify-between h-[68px] ">
          <h2 className="text-[#FAFCFD] font-bold text-[24px]  leading-[24px] tracking-[-0.01em] font-[Merriweather]">
            Notices & Announcements
          </h2>
         
       <button onClick={() => setCreateAnnouncement(true)} className="flex items-center gap-3 bg-[#FAFCFD] rounded-[8px] px-4 py-2 text-[#1F1D1D] text-[14px] leading-[24px] font-[Inter] font-normal shadow-sm ">
  ...
  `}
       ...
       {createAnnouncement && (
        <div className="fixed inset-0 flex items-center justify-center px-4 z-50">
          ...
          <div className="relative z-50 bg-[#FAFCFD] w-full max-w-[528px] rounded-[12px] overflow-y-auto shadow-xl">
